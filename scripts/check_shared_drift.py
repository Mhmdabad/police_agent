...
DIVERGENT: dict[str, str] = {
    "strategy/police_search.py": "this role's searching brain: the cop maximises capture, and places barriers",
    ...
    "domain/outcome_technical.py": "capture-claim framing differs by role",
    ...
    "strategy/barriers_geometry.py": "cop-only; the thief has no barriers to place",
    "strategy/barriers_score.py": "cop-only; the thief has no barriers to place",
    "strategy/barriers_win.py": "cop-only; the thief has no barriers to place",
    ...
    "strategy/police_brain_pursuit.py": "the cop's policy; no counterpart there",
