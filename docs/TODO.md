...
### GUI
- [ ] Live GUI (Tkinter/PyQt) showing **local truth only** — never the thief's real cell
...
- [ ] `log_<game_id>_g<NN>.json` — full step record including barrier declarations
...
- [ ] Pre-match negotiation protocol: board, starts, barrier quota, `map_area`,
