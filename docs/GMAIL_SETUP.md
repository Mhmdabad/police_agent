...
| Step | What | Issue |
|---|---|---|
| 2 | OAuth Consent Screen, team members as Test Users | #104 |
| 3 | Scope restricted to `gmail.send` and nothing else | #105 |
| 4 | OAuth Client ID (Desktop Application) → `credentials.json` | #106 |
| 5 | First authorization flow → `token.json` | #107 |
