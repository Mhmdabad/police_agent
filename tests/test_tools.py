...
from cop_agent.infra.tools import (
    PROTOCOL_VERSION,
    PeerIdentity,
    ToolResult,
    ToolSurface,
...
class TestHandshake:
    ...
    def test_announces_our_group_id(self) -> None:
        assert surface().handshake("them", "thief", PROTOCOL_VERSION).data["group_id"] == "s82kma9e"
