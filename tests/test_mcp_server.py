...
from cop_agent.infra.inboxes import TOOL_NAMES, PeerInboxes
from cop_agent.infra.mcp_server import (
    BIND_HOST,
    DEFAULT_TRANSPORT,
    SERVER_NAME,
    ServerSettings,
...
class TestFromConfig:
    ...
    def test_our_port_differs_from_the_cops(self) -> None:
        ...
        path = Path(__file__).parents[1] / "config/police/game.toml"
        private = tomllib.loads(path.read_text())
        assert "8802" in private["network"]["opponent_url"]
