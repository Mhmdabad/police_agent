...
from cop_agent.infra.declaration_parties import DeclarationError
from cop_agent.infra.match_ledger import LEDGER_FILE, MatchLedger
from cop_agent.runtime.driver_declaration import _record_game
...
class TestTheCountIsSigned:
    def test_it_is_inside_the_content_the_signature_covers(self) -> None:
        ...
        assert "games_already_played" in build_declaration("police", "g1", "u-0001").content()

    def test_changing_the_count_changes_the_signed_bytes(self) -> None:
        from dataclasses import replace

        one = build_declaration("police", "g1", "u-0001")
    ...
    def test_a_negative_count_is_refused_at_construction(self) -> None:
        ...
        with pytest.raises(DeclarationError, match="games_already_played"):
            replace(build_declaration("police", "g1", "u-0001"), games_already_played=-1)
...
class TestARehearsalIsNotAGame:
    def test_a_rehearsal_leaves_the_count_alone(self, tmp_path: Path) -> None:
        ...
        declaration = build_declaration("police", "uoh26-g1", "u-0001")
