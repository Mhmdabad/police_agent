...
The rulebook's contract: point ``[strategy] police_class`` at a class in
...
DEFAULT_BRAIN = "cop_agent.strategy.police_brain:PoliceBrain"
...
def load_brain(
    ...
    """
    spec = (strategy or {}).get("police_class") or DEFAULT_BRAIN
    if not isinstance(spec, str) or spec.count(":") != 1:
        raise StrategyError(f"police_class must be 'package.module:Class', got {spec!r}")
...
__all__ = ["DEFAULT_BRAIN", "BrainBase", "PoliceBrain", "StrategyError", "load_brain"]
